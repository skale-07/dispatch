...
"=== cycle 3 start $(Get-Date -Format o) (backlog, max-apps 1, max-submits 1, app-deadline 300) ===" | Out-File $log -Append -Encoding utf8
...
"=== cycle 3 end $(Get-Date -Format o) exit $LASTEXITCODE ===" | Out-File $log -Append -Encoding utf8
