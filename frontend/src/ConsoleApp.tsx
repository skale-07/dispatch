...
/**
 * The INTERNAL operator console — the whole app this frontend used to be.
 * Mounted only when the build sets VITE_CONSOLE_ENABLED=true (an
 * operator's local build); the public consumer app (PublicApp) neither
 * mounts nor links it, ever. Behavior in console mode is unchanged.
 *
...
export function ConsoleApp(): JSX.Element {
  ...
  useEffect(() => {
    document.title = "Dispatch — application operator console";
  }, []);
